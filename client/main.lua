...
function OpenPoliceActionsMenu()
	local elements = {
		...
		{icon = "fas fa-cube", title = TranslateCap('object_spawner'), value = 'object_spawner'}
	}
	ESX.OpenContext("right", elements, function(menu,element)
		local data = {current = element}
		...
		if data.current.value == 'citizen_interaction' then
			local elements2 = {
				...
				{icon = "fas fa-magnifying-glass", title = TranslateCap('search'), value = 'search'},
				{icon = "fas fa-handcuffs", title = TranslateCap('handcuff'), value = 'handcuff'},
				{icon = "fas fa-up-down-left-right", title = TranslateCap('drag'), value = 'drag'},
				{icon = "fas fa-car-side", title = TranslateCap('put_in_vehicle'), value = 'put_in_vehicle'},
				{icon = "fas fa-right-from-bracket", title = TranslateCap('out_the_vehicle'), value = 'out_the_vehicle'},
				{icon = "fas fa-file-invoice-dollar", title = TranslateCap('fine'), value = 'fine'},
				{icon = "fas fa-file-invoice", title = TranslateCap('unpaid_bills'), value = 'unpaid_bills'}
			}
		...
		elseif data.current.value == "object_spawner" then
			local elements4 = {
				{unselectable = true, icon = "fas fa-cube", title = element.title},
				{icon = "fas fa-triangle-exclamation", title = TranslateCap('cone'), model = 'prop_roadcone02a'},
				{icon = "fas fa-road-barrier", title = TranslateCap('barrier'), model = 'prop_barrier_work05'},
				{icon = "fas fa-road-spikes", title = TranslateCap('spikestrips'), model = 'p_ld_stinger_s'}
			}
