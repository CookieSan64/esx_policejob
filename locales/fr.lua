Locales['fr'] = {
  ...
  ['fine_enter_amount'] = "Entrez le montant de l'amende",
  ['fine_enter_text'] = "Entrez la raison de l'amende",
  ['invalid_amount'] = 'Erreur : Le montant n\'était pas un nombre ou invalide',  
