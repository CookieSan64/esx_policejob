...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			vector3(462.1421, -996.4987, 30.68958)
		},
		Armories = {
			vector3(485.0884, -995.2769, 30.68981)
		},
		Vehicles = {
			{
				Spawner = vector3(454.6, -1017.4, 0.4),
			...
			{
				Spawner = vector3(473.3, -1018.8, 0.0),
		...
		Helicopters = {
			{
				Spawner = vector3(461.1, -981.5, 0.6),
		...
		BossActions = {
			vector3(459.471, -984.8279, 30.68999)
		}
	}
}
...
Config.AuthorizedVehicles = {
	car = {
		...
		sergeant = {
			{model = 'lspdvic', price = 0},
			{model = 'lspd18char', price = 0},
			{model = 'policeb', price = 0},
			{model = 'pbus', price = 0},
		},
		lieutenant = {
			{model = 'lspd20exp', price = 0},
			{model = 'lspd18char', price = 0},
			{model = 'policeb', price = 0},
			{model = 'riot', price = 0},
			{model = 'fbi2', price = 0},
		...
		boss = {
			{model = 'lspd21f150', price = 0},
			{model = 'lspdcap', price = 0},
			{model = 'lspddur', price = 0},
			{model = 'lspdtaur', price = 0},
			{model = 'lspdvet', price = 0},
			{model = 'lspd18tahoe', price = 0},
			{model = 'policeb', price = 0},
			{model = 'riot', price = 0},
			{model = 'fbi2', price = 0},
			{model = 'pbus', price = 0},
